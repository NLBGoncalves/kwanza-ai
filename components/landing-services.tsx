...
export const LandingServices = () => {
    return(
        <div className="px-10 pb-20 grid lg:grid-rows-10 sm:grid-rows-1 mr-10 md:grid-rows-1 md:grid-flow-col">
        <div className="p-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-10 md:row-span-10 md:col-span-10 ">
            {routes.map((route) => (
